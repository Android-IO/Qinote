...
//    }
    ...
    public class NoPictureViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NoPictureViewHolder(View view) {
            super(view);
            mNoteOptionButton = (Button) view.findViewById(R.id.no_picture_option_button);
            mNoteContentTextView = (TextView) view.findViewById(R.id.no_picture_content_textview);
            view.setOnClickListener(this);
        }
    ...
    public class NoTextMoreThanOnePictureViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NoTextMoreThanOnePictureViewHolder(final View view) {
            super(view);
            mNoteOptionButton = (Button) view.findViewById(R.id.no_text_more_than_one_picture_option_button);
            mNotePictureImageView1 = (ImageView) view.findViewById(R.id.no_text_more_than_one_picture_note_picture_imageview1);
            mNotePictureImageView2 = (ImageView) view.findViewById(R.id.no_text_more_than_one_picture_note_picture_imageview2);
//            view.setOnClickListener(this);
        }
...
//            Toast.makeText(mContext,"Current position is "+String.valueOf(adapterPosition),Toast.LENGTH_SHORT).show();
    ...
    public class NoTextOnlyOnePictureViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NoTextOnlyOnePictureViewHolder(View view) {
            super(view);
            mNoteOptionButton = (Button) view.findViewById(R.id.no_text_only_one_picture_option_button);
            mNotePictureImageView = (ImageView) view.findViewById(R.id.no_text_only_one_picture_note_picture_imageview);
            view.setOnClickListener(this);
        }
    ...
    public class TextPictureViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextPictureViewHolder(View view) {
            super(view);
            mNoteOptionButton = (Button) view.findViewById(R.id.text_picture_option_button);
            mNotePictureImageView = (ImageView) view.findViewById(R.id.text_picture_note_picture_imageview);
            mNoteContentTextView = (TextView) view.findViewById(R.id.text_picture_content_textview);
            view.setOnClickListener(this);
        }
